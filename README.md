...
Users can create channels and send/receive messages real time. With kind inspiration from [Kasey Markham](https://medium.com/@builtbykasey).
...
# In Case You'd Like to Build the Project Yourself:
